    ...
    class cClientes
    {
        ...
        public int InsertaCliente()
        {
            try
            {
                ...
                Comando.Parameters.Add("@Nombre", SqlDbType.VarChar).Value = this.NombreCliente;
                ...
                //Guardar Clientes
                Comando = new SqlCommand("RegistraCliente", Conexion);
                Comando.CommandType = CommandType.StoredProcedure;
                ...
                Comando.Parameters.Add("@NombreCliente", SqlDbType.VarChar).Value = this.NombreCliente;
        ...
        public int ModificaCliente()
        {
            try
            {
                ...
                //Guardar Clientes
                Comando = new SqlCommand("ModificaCliente", Conexion);
                Comando.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet ConsultaClientes(string Nombre)
        {
            try
            {
                ...
                if (DS.Tables[0].Rows.Count > 0)
                {
                    ...
                    throw new Exception("No existe ese número de alumno");
        ...
        public void ConsultaUno(string Valor)
        {
            try
            {
                ...
                //this._cp = Convert.ToInt32(DRD["IdCP"].ToString());
        ...
        public int EliminaCliente(string Nombre)
        {
            try
            {
                int Actualizados = 0;
                ...
                Comando.CommandType = CommandType.StoredProcedure;
                Comando.Parameters.Add("@Nombre", SqlDbType.VarChar).Value = Nombre;
                Comando.Parameters.Add("@Valor", SqlDbType.VarChar).Value = this.IdCliente;
